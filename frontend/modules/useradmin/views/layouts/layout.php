...
<?php $this->beginPage() ?>
    ...
    <div id="top" class="clearfix">
        ...
        <div class="applogo">
            ...
            <a href="<?=Url::home()?>" class="logo">
                <img src="/gbii/frontend/web/logo2_s_w280.png" alt="logo" style="height: 37px;margin: -8px 0px"/>
            </a>
        </div>
        <!-- End App Logo -->
        ...
        $menuItemsCenter = [
            ...
            ['label' => '拼租', 'url' => ['/useradmin/loader/create']],
            ['label' => '帮助', 'url' => ['/site/about']],
            ['label' => '成为房东', 'url' => ['/help/index']],
    ...
    <div class="sidebar clearfix">
        ...
        <ul class="sidebar-panel nav">
            ...
            <li><a href="<?= Url::toRoute('/admin')?>"><span class="icon color5"><i class="fa fa-home"></i></span>房东平台<span class="label label-default"></span></a></li>

            <li><a href="#"><span class="icon color7"><i class="fa fa-flask"></i></span>房屋管理<span class="caret"></span></a>
                <ul>
                    <li><a href="<?= Url::toRoute('news/index')?>"> 短租 </a></li>
                    <li><a href="layouts.html">长租</a></li>
                </ul>
            </li>
            <li><a href="#"><span class="icon color7"><i class="fa fa-flask"></i></span>住宿<span class="caret"></span></a>
                <ul>
                    <li><a href="<?= Url::toRoute('news/index')?>"> 短租 </a></li>
                    <li><a href="layouts.html">长租</a></li>
                </ul>
            ...
            <li><a href="#"><span class="icon color10"><i class="fa fa-check-square-o"></i></span>设置<span class="caret"></span></a>
        ...
        <ul class="sidebar-panel nav">
            <li class="sidetitle"></li>
            <li><a href="grid.html"><span class="icon color15"><i class="fa fa-columns"></i></span>市场分析</a></li>
            <li><a href="maps.html"><span class="icon color7"><i class="fa fa-map-marker"></i></span>交易分析</a></li>
