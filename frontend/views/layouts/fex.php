...
<section>
    ...
    if (Yii::$app->user->isGuest) {
        ...
        $menuItems[] =[
            ...
            'items'=>[
                ['label'=>'<li><a href="'.$url.'/useradmin/customer/index" class="items-a"><i class="icon-screenshot"></i> 个人中心</a></li>'],
                /* ['label'=>'<i class="icon-signout"></i> 退出','url'=>'/site/logout','linkOptions'=>['data-method'=>'post']],*/
                ['label'=>'<li><a class="logout"><i class="icon-signout"></i>'
            ...
            //'options'=>['class'=>'dropdown-menu dropdown-menu-usermenu pull-right'],
            //'itemsOption'=>['class'=>'dropdown-menu dropdown-menu-usermenu pull-right']
            /*
